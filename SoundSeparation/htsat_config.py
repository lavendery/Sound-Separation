...
input_stft_abs = False
input_ov_stft2mel = False
input_ov_stft2melchannel = True
input_ov_stft2complex = False
inchannel = 32   #if input_ov_stft2melchannel or input_ov_stft2complex : inchannel=32(dense_layer_width=inchannel), else: inchannel=1
...
resume_checkpoint = "./HTS-Audio-Transformer/htsat_exp/results/exp/checkpoint/lightning_logs/version_0/HTSAT_AudioSet_Saved_0.ckpt"
